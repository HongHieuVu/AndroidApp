...
- All services and controllers interact via messages (actions), irrespective of what that service's API is like (this is anonymity). Every function of every service has its own associated message subclass.
